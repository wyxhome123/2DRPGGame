...
public class SkeletonStunnedState : EnemyState
{
    ...
    public SkeletonStunnedState(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _aniBoolName, Enemy_Skeleton _enemy) : base(_enemyBase, _stateMachine, _aniBoolName)
    {
        enemy = _enemy;
    }
