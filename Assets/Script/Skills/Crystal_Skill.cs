...
public class Crystal_Skill : Skill
{
    ...
    public void CreateCrystal(){
        ...
        Crystal_Skill_Controller currentCrystalSrcript = currentCrystal.GetComponent<Crystal_Skill_Controller>();

        currentCrystalSrcript.SetupCrystal(crystalDuration, canExplode, canMoveToEnemy, moveSpeed, FindClosestEnemy(currentCrystal.transform));
    }
